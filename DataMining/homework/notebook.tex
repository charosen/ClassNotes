...
\subsection{1.（b)答案：}\label{bux7b54ux6848}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{c+c1}{\PYZsh{} 排序数据}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}5}]:} <matplotlib.axes.\_subplots.AxesSubplot at 0x117c8a668>
\end{Verbatim}
...
\subsection{1.(c)答案：}\label{cux7b54ux6848}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{n}{p\PYZus{}min}\PY{p}{,} \PY{n}{p\PYZus{}max} \PY{o}{=} \PY{n+nb}{min}\PY{p}{(}\PY{n}{price}\PY{p}{)}\PY{p}{,} \PY{n+nb}{max}\PY{p}{(}\PY{n}{price}\PY{p}{)}
...
\subsection{1.(d)答案}\label{dux7b54ux6848}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{k+kn}{from} \PY{n+nn}{scipy}\PY{n+nn}{.}\PY{n+nn}{stats} \PY{k}{import} \PY{n}{pearsonr}
...
pearson互相关系数计算一： 0.5363070272140884
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{pearson互相关系数计算二：}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{np}\PY{o}{.}\PY{n}{corrcoef}\PY{p}{(}\PY{n}{price}\PY{p}{,} \PY{n}{weight}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}
\end{Verbatim}
...
余弦相似度：x1, x3, x4, x2, x5;
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{c+c1}{\PYZsh{} 第二题}
...
欧式距离：x1, x3, x4, x2, x5
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}10}]:} \PY{k+kn}{from} \PY{n+nn}{sklearn} \PY{k}{import} \PY{n}{preprocessing}
         ...
         \PY{c+c1}{\PYZsh{} print(x\PYZus{}normalized)}
         \PY{c+c1}{\PYZsh{} print(dataset\PYZus{}normalized)}
